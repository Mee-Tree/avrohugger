...
class SpecificGeneratorToolSpec extends mutable.Specification {
  ...
  "match the expected single protocol file" in {
    ...
    (Util.readFile(Directory.TEST_OUTPUT_SPECIFIC_MAIL) === Util.readFile(Directory.TEST_EXPECTED_SPECIFIC_MAIL)) and
  ...
  "match the expected dependent files" in {
    ...
    (Util.readFile(Directory.TEST_OUTPUT_SPECIFIC_NICKNAME) === Util.readFile(Directory.TEST_EXPECTED_SPECIFIC_NICKNAME)) and
  ...
  "match the expected file and directory" in {
    ...
    (Util.readFile(Directory.TEST_OUTPUT_SPECIFIC_MASCOT) === Util.readFile(Directory.TEST_EXPECTED_SPECIFIC_MASCOT)) and
