...
final case class Embedded(var inner: Int) extends org.apache.avro.specific.SpecificRecordBase with Defaults {
  ...
  def getSchema: org.apache.avro.Schema = example.idl.java.Embedded.SCHEMA$
}
...
final case class DefaultTest(var suit: DefaultEnum = DefaultEnum.SPADES, var number: Int = 0, var str: String = "str", var optionString: Option[String] = None, var optionStringValue: Option[String] = Some("default"), var embedded: example.idl.java.Embedded = new Embedded(1), var defaultArray: Seq[Int] = Seq(1, 3, 4, 5), var optionalEnum: Option[DefaultEnum] = None, var defaultMap: Map[String, String] = Map("Hello" -> "world", "Merry" -> "Christmas"), var byt: Array[Byte] = Array[Byte](-61, -65)) extends org.apache.avro.specific.SpecificRecordBase with Defaults {
  ...
  def getSchema: org.apache.avro.Schema = example.idl.java.DefaultTest.SCHEMA$
}
