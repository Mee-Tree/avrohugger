...
final case class DependentRecord(var dependency: other.ns.java.ExternalDependency, var number: Int) extends org.apache.avro.specific.SpecificRecordBase with ImportProtocol {
  ...
  def put(field$: Int, value: Any): Unit = {
    (field$: @switch) match {
      case 0 => this.dependency = {
        value
      }.asInstanceOf[other.ns.java.ExternalDependency]
      case 1 => this.number = {
        value
      }.asInstanceOf[Int]
      case _ => new org.apache.avro.AvroRuntimeException("Bad index")
  ...
  def getSchema: org.apache.avro.Schema = example.idl.java.DependentRecord.SCHEMA$
}
...
final case class DependentRecord2(var dependency: Suit, var name: String) extends org.apache.avro.specific.SpecificRecordBase with ImportProtocol {
  ...
  def getSchema: org.apache.avro.Schema = example.idl.java.DependentRecord2.SCHEMA$
}
...
final case class DependentRecord3(var dependency: example.idl.java.Embedded, var value: Boolean) extends org.apache.avro.specific.SpecificRecordBase with ImportProtocol {
  ...
  def put(field$: Int, value: Any): Unit = {
    (field$: @switch) match {
      case 0 => this.dependency = {
        value
      }.asInstanceOf[example.idl.java.Embedded]
      case 1 => this.value = {
        value
  ...
  def getSchema: org.apache.avro.Schema = example.idl.java.DependentRecord3.SCHEMA$
}
